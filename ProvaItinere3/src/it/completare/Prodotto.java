 ...
 * cod2prod, associa un codice di tipo String ad un oggetto di tipo Prodotto. La seconda, cod2qta, associa un codice di tipo String ad una
 * quantità di tipo Integer.
 ...
 * E' possibile che per alcuni prodotti non siano riportate le quantità. In quel caso il prodotto deve essere riportato con quantità pari a -1.
...
public class Prodotto {
	...
	public class OperazioniProdotti{
		public Map<Prodotto, Integer> getProdotto2quantita(Map<String, Prodotto> cod2prodotto){
